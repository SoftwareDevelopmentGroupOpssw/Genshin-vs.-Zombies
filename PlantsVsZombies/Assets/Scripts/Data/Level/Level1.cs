...
public class Level1 : GridLevel
{
    ...
    private const float commonPossiblity = 0.5f;//普通僵尸概率
    private const float roadConePossiblity = 0.3f;//路障僵尸概率
    private const float bucketPossiblity = 0.2f;//铁桶僵尸概率
    ...
    public override IEnumerator GenerateEnumerator()
    {
        ...
        float geneateSpaceTime = 18f;//生成间隔
        int realMinGenerateCount = 1;//最小生成数量
        int realMaxGenerateCount = 15;//最大生成数量
        int fixedCount = 7; //（修正值）当关卡进度达到100%时 生成数量会增加这么多 
